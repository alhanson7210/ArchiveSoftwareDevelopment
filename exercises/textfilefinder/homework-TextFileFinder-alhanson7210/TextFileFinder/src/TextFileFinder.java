...
public class TextFileFinder {
   ...
   */
  // TODO Fill in isText using a lambda expression
  ...
  public static Stream<Path> find(Path start) throws IOException {
    // TODO Fill in find(Path) using streams
	try {
		return Files.find(start, Integer.MAX_VALUE, isTextWithAttribute, FileVisitOption.FOLLOW_LINKS);
	} catch (IOException e) { throw new IOException("Error occured with finding files");
	}
  }
